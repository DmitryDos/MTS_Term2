...
import app.exceptions.RatingException;
...
public class BookRatingProducer {
  ...
  public void stubBookRating(@PathVariable @NotNull Long bookId)
    ...
    String message = objectMapper.writeValueAsString(new RatingBookMessageResponse(bookId, rating));
    ...
    try {
      ...
      throw new RatingException("Couldn't send message to Kafka");
    } catch (TimeoutException e) {
      throw new RatingException("Couldn't send message to Kafka due to timeout");
    }
  }
}
